...
<a href="{{ route('shop.product', $product) }}" class="group shop-card block">
    <div class="shop-media rounded-xl relative">
        ...
        @if (! $product->is_in_stock)
            <span class="absolute top-3 right-3 inline-flex items-center rounded-full bg-white/95 px-2.5 py-1 text-xs font-semibold text-shop-muted ring-1 ring-inset shop-hairline">Sold Out</span>
        @endif
    </div>
    <div class="mt-4">
